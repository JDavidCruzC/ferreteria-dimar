        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src={logo} alt="DIMAR" className="h-12 object-contain" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2"><MapPin className="h-4 w-4 shrink-0 mt-0.5 text-primary" />{settings.footer_address}</li>
          ...
          {/* Map */}
          <div>
            <h3 className="font-display font-semibold mb-4 text-sm uppercase tracking-wider text-primary">Ubícanos</h3>
            <div className="rounded-lg overflow-hidden border border-primary/20 aspect-square bg-secondary">
              <iframe
                title="Ubicación DIMAR"
                src={settings.footer_map_embed_url}
