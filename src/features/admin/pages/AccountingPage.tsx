...
const AccountingPage = () => {
  ...
  const closeForm = () => {
    setFormOpen(false);
    setEditingId(null);
    setForm({ fecha: new Date().toISOString().split("T")[0], cliente_nombre: "", cliente_telefono: "", notas: "", emitido_por: "Personal de DIMAR" });
    setItems([]);
  };
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Select value={form.emitido_por} onValueChange={v => setForm({ ...form, emitido_por: v })}>
                  ...
                  <SelectContent>
                    <SelectItem value="Personal de DIMAR">Personal de DIMAR</SelectItem>
